...
<div class="grid1">
  ...
  <div class="side_nav">
    ...
    elseif (!empty($_GET['PID'])){
                    ...
                    <table class="table_in">
                      <tr>
                        <form action="preview.php?ID=<?php echo $_GET['ID']; ?>&PID=<?php echo $_GET['PID']; ?> " method="POST">
                         <td id= itemNamet3>
                    ...
                    if(!empty($_GET['ITEM'])){
                      ...
                      echo " <div class='wrapper_preview'>";
                        ...
                        <table class="table_in">
                          <tr>
                            <form action="inset_req3.php?ID=<?php echo $_GET['ID']; ?>&PID=<?php echo $_GET['PID']; ?>" method="POST" >
  ...
  if( $conn->query( $query ) ){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
      ...
      echo "<td> <input id='itemname1' type='text' name ='item4' value ='". iconv('TIS-620', 'UTF-8',$row['ItemName']) ." ' maxlength='255'>
