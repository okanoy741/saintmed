                      ...
                      if( $conn->query( $query ) ){
                        if($_GET['ID']){
                          ...
                          while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)){
                            ...
                            <p> เงื่อนไขพิเศษ :  
                            <select name='itemcondi' id='conditions' required>
                            <option value=''>". iconv('TIS-620', 'UTF-8',$row2['condition_id']) ."(". iconv('TIS-620', 'UTF-8',$row2['condition_info']) .")</option>
                            <option value='อายุสินค้ามากกว่า 6 เดือน'>อายุสินค้ามากกว่า 6 เดือน</option>
                            <option value='อายุสินค้ามากกว่า 1 ปี'>อายุสินค้ามากกว่า 1 ปี</option>
                            <option value='ต้องส่งสินค้าครบทุกรายการ'>ต้องส่งสินค้าครบทุกรายการ</option>
                            <option value='ไม่มีเงื่อนไขพิเศษ'>ไม่มีเงื่อนไขพิเศษ</option>
                  ...
                  <script>
                    function myFunction() {
                      ...
                      if (checkBox.checked == true){
                        $('.cReg2_btn').attr('disabled',false);
                      } else {
                       $('.cReg2_btn').attr('disabled',true);
                     }
                   }
                 </script>
               </body>
